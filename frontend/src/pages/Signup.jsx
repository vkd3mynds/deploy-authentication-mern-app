...
const Signup = () => {
    ...
    const handleSignup = async(e)=>{
        ...
        if(!name || !email || !password){
            return handleError("name, Email, Password was required")
        }
      ...
      <div className="container">
        ...
        <form onSubmit={handleSignup}>
          ...
          <div>
            ...
            <input onChange={handleChange} type="email" name="email" placeholder="Enter your mail..." value={signupInfo.email}/>
          </div>
          <div>
